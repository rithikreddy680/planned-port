  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-black/35 via-black/15 to-transparent dark:from-black/50 dark:via-black/20" />
